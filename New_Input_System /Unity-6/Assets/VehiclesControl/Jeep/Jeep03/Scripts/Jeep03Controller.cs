/*
 * File: Jeep 03 Controller (New Input System)
 * Name: Jeep03Controller.cs
...
namespace VehiclesControl
{
	// public enum Jeep03SpeedType
	public enum Jeep03SpeedType
	{
		mph,
		kmh	

	} // close public enum Jeep03SpeedType
	...
	// public class Jeep03Controller
	public class Jeep03Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// Jeep03SpeedType _speedType	
			[SerializeField] private Jeep03SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Jeep03SpeedType.mph
			if (_speedType == Jeep03SpeedType.mph)
			{
			...
			} // close if _speedType equals Jeep03SpeedType.mph

			// else if _speedType equals Jeep03SpeedType.kmh
			else if (_speedType == Jeep03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Jeep03SpeedType.kmh
	...
	} // close public class Jeep03Controller
