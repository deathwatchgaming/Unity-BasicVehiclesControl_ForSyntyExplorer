...
namespace VehiclesControl
{
	...
	public class Jeep03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _jeep03.InverseTransformDirection(_jeep03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _jeep03.GetComponent<Rigidbody>().velocity.magnitude;
