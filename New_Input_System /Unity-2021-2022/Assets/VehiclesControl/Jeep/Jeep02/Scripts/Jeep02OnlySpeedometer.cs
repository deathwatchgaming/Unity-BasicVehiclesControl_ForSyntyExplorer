/*
 * File: Jeep 02 Only Speedometer
 * Name: Jeep02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Jeep02OnlySpeedUnit
	public enum Jeep02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Jeep02OnlySpeedUnit

	// public class Jeep02OnlySpeedometer 
	public class Jeep02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Jeep02OnlySpeedUnit _speedUnit	
			[SerializeField] private Jeep02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Jeep02OnlySpeedUnit.mph
			if (_speedUnit == Jeep02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Jeep02OnlySpeedUnit.mph
	...
	} // close public class Jeep02OnlySpeedometer
