...
namespace NavigationControl
{
	...
	public class PlayerCompass : MonoBehaviour
	{
		...
		public static PlayerCompass _playerCompass;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component PlayerCompass is enabled
				GetComponent<PlayerCompass>().enabled = true;

				// Debug Log Player compass is enabled
			...
			{
				// Debug Log Player compass is disabled
				...
				// Get Component PlayerCompass is not enabled
				GetComponent<PlayerCompass>().enabled = false;
	...
	} // close public class PlayerCompass
