...
namespace VehiclesControl
{
	...
	public class Jeep02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _jeep02.InverseTransformDirection(_jeep02.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _jeep02.GetComponent<Rigidbody>().velocity.magnitude;
