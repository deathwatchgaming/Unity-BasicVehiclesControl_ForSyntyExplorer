...
namespace VehiclesControl
{
	...
	public class Jeep01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _jeep01.InverseTransformDirection(_jeep01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _jeep01.GetComponent<Rigidbody>().velocity.magnitude;
