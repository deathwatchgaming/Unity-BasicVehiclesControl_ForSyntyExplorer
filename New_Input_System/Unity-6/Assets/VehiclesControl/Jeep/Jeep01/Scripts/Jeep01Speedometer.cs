/*
 * File: Jeep 01 Speedometer (New Input System)
 * Name: Jeep01Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Jeep01SpeedUnit
	public enum Jeep01SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Jeep01SpeedUnit

	// public class Jeep01Speedometer 
	public class Jeep01Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Jeep01SpeedUnit _speedUnit	
			[SerializeField] private Jeep01SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Jeep01_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Jeep01_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Jeep01_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Jeep01_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Jeep01_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Jeep01_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Jeep01Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Jeep01Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Jeep01SpeedUnit.mph
			if (_speedUnit == Jeep01SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Jeep01SpeedUnit.mph
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inJeep01 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class Jeep01Speedometer
