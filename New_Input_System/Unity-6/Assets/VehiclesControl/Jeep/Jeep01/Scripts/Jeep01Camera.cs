...
namespace VehiclesControl
{
	...
	public class Jeep01Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The jeep 01 transform")]
			// Transform _jeep01
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _jeep01.position.y plus _height
			float _desiredHeight = _jeep01.position.y + _height;
			...
			// transform position is _jeep01.position
			transform.position = _jeep01.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _jeep01.InverseTransformDirection(_jeep01.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _jeep01.eulerAngles.y plus 180
				_tempVector3.y = _jeep01.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _jeep01.eulerAngles.y
				_tempVector3.y = _jeep01.eulerAngles.y;
			...
			float _autoCamControl = _jeep01.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class Jeep01Camera
