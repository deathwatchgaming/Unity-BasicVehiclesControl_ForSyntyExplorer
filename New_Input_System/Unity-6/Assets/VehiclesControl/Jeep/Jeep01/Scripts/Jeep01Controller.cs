/*
 * File: Jeep 01 Controller (New Input System)
 * Name: Jeep01Controller.cs
...
namespace VehiclesControl
{
	// public enum Jeep01SpeedType
	public enum Jeep01SpeedType
	{
		mph,
		kmh	

	} // close public enum Jeep01SpeedType
	...
	// public class Jeep01Controller
	public class Jeep01Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// Jeep01SpeedType _speedType	
			[SerializeField] private Jeep01SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Jeep01SpeedType.mph
			if (_speedType == Jeep01SpeedType.mph)
			{
			...
			} // close if _speedType equals Jeep01SpeedType.mph

			// else if _speedType equals Jeep01SpeedType.kmh
			else if (_speedType == Jeep01SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Jeep01SpeedType.kmh
	...
	} // close public class Jeep01Controller
