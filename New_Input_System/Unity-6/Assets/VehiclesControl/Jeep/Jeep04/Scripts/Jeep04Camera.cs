...
namespace VehiclesControl
{
	...
	public class Jeep04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _jeep04.InverseTransformDirection(_jeep04.GetComponent<Rigidbody>().linearVelocity);
			...
			float _autoCamControl = _jeep04.GetComponent<Rigidbody>().linearVelocity.magnitude;
