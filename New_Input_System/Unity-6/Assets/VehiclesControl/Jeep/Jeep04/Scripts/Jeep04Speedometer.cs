/*
 * File: Jeep 04 Speedometer (New Input System)
 * Name: Jeep04Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Jeep04SpeedUnit
	public enum Jeep04SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Jeep04SpeedUnit

	// public class Jeep04Speedometer 
	public class Jeep04Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Jeep04SpeedUnit _speedUnit	
			[SerializeField] private Jeep04SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Jeep04_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Jeep04_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Jeep04_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Jeep04_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Jeep04_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Jeep04_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Jeep04Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Jeep04Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Jeep04SpeedUnit.mph
			if (_speedUnit == Jeep04SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Jeep04SpeedUnit.mph
	...
	} // close public class Jeep04Speedometer
