/*
 * File: Jeep 04 Controller (New Input System)
 * Name: Jeep04Controller.cs
...
namespace VehiclesControl
{
	// public enum Jeep04SpeedType
	public enum Jeep04SpeedType
	{
		mph,
		kmh	

	} // close public enum Jeep04SpeedType
	...
	// public class Jeep04Controller
	public class Jeep04Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// Jeep04SpeedType _speedType	
			[SerializeField] private Jeep04SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Jeep04SpeedType.mph
			if (_speedType == Jeep04SpeedType.mph)
			{
			...
			} // close if _speedType equals Jeep04SpeedType.mph

			// else if _speedType equals Jeep04SpeedType.kmh
			else if (_speedType == Jeep04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Jeep04SpeedType.kmh
	...
	} // close public class Jeep04Controller
