...
namespace VehiclesControl
{
	...
	public class Jeep03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The jeep 03 transform")]
			// Transform _jeep03
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _jeep03.position.y plus _height
			float _desiredHeight = _jeep03.position.y + _height;
			...
			// transform position is _jeep03.position
			transform.position = _jeep03.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _jeep03.InverseTransformDirection(_jeep03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _jeep03.eulerAngles.y plus 180
				_tempVector3.y = _jeep03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _jeep03.eulerAngles.y
				_tempVector3.y = _jeep03.eulerAngles.y;
			...
			float _autoCamControl = _jeep03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class Jeep03Camera
