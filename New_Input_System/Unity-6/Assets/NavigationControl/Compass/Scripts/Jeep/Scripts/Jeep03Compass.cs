/*
*  Name: Jeep 03 Compass
*  File: Jeep03Compass.cs
...
namespace NavigationControl
{
	// public class Jeep03Compass
	public class Jeep03Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Jeep03 transform")]
			// Transform _jeep03
			[SerializeField] private Transform _jeep03;
		...
		public static Jeep03Compass _jeep03Compass;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Jeep03Compass is enabled
				GetComponent<Jeep03Compass>().enabled = true;

				// Debug Log Jeep03 compass is enabled
			...
			{
				// Debug Log Jeep03 compass is disabled
				...
				// Get Component Jeep03Compass is not enabled
				GetComponent<Jeep03Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _jeep03 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_jeep03.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _jeep03 forward vector

			// Vector3 forward is _jeep03 transform forward
			Vector3 forward = _jeep03.transform.forward;

			// Zero out the Y of _jeep03 forward vector to only get the direction in the X,Z 
	...
	} // close public class Jeep03Compass
